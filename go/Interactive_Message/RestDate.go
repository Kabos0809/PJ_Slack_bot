...
func RestDateButtonPushedActionHandle() slack.MsgOption {
	...
	addButtonSection := slack.NewSectionBlock(addButtonSectionText, nil, addButtonElement)
	...
	deleteButtonSection := slack.NewSectionBlock(deleteButtonSectionText, nil, deleteButtonElement)

	blocks := slack.MsgOptionBlocks(dstText, dividerBlock, addButtonSection, deleteButtonSection)
